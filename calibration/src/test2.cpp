...
public:
  LidarPattern()
      : Node("lidar_pattern"), count_(0)
  {
  }

private:
  rclcpp::Subscription<sensor_msgs::msg::PointCloud2::ConstPtr>::SharedPtr sub = this->create_subscription<sensor_msgs::msg::PointCloud2::ConstPtr>(
      "cloud1", 100, std::bind(&LidarPattern::callback, this, _1));
  
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr range_pub;
  if (DEBUG)
  {
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pattern_pub;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr rotated_pattern_pub
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr cumulative_pub
  }

  void callback(const sensor_msgs::msg::PointCloud2::ConstPtr &laser_cloud)
  {
  }
  size_t count_;
};
...
int main(int argc, char **argv)
{
  ...
  while (rclcpp::ok())
  {
    rclcpp::spin(std::make_shared<LidarPattern>());
  }
  rclcpp::shutdown();
  return 0;
